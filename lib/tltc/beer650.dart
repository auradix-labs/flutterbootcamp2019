...
class Beer650 extends StatefulWidget {
  @override
  _Beer650State createState() => _Beer650State();
}

class _Beer650State extends State<Beer650> {
  var dutySlabs = ExciseDutySlab.getBeer650Slabs();
